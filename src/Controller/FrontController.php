...
class FrontController extends AbstractController
{
     ...
     */
    public function videoList($id ,$page, CategoryTreeFrontPage $categories, Request $request, VideoForNotValidSubscription $video_no_members,
     ...
     */
    public function videoDetails(VideoRepository $repo ,$video, VideoForNotValidSubscription $video_no_members)
    {
